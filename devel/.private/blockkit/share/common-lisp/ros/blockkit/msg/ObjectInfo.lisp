...
(cl:defmethod cl:initialize-instance :after ((m <ObjectInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name blockkit-msg:<ObjectInfo> is deprecated: use blockkit-msg:ObjectInfo instead.")))

(cl:ensure-generic-function 'object_class-val :lambda-list '(m))
(cl:defmethod object_class-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blockkit-msg:object_class-val is deprecated.  Use blockkit-msg:object_class instead.")
  (object_class m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blockkit-msg:x-val is deprecated.  Use blockkit-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blockkit-msg:y-val is deprecated.  Use blockkit-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blockkit-msg:z-val is deprecated.  Use blockkit-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blockkit-msg:angle-val is deprecated.  Use blockkit-msg:angle instead.")
  (angle m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ObjectInfo>)))
  ...
  "cf579c7ee3f17dc8942b83838c4a2ce1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ObjectInfo)))
  "Returns md5sum for a message object of type 'ObjectInfo"
  "cf579c7ee3f17dc8942b83838c4a2ce1")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObjectInfo>)))
  ...
  (cl:format cl:nil "string object_class  ~%float64 x            ~%float64 y            ~%float64 z ~%float64 angle       # object rotation angle in camera frame (radians)~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObjectInfo)))
  "Returns full string definition for message of type 'ObjectInfo"
  (cl:format cl:nil "string object_class  ~%float64 x            ~%float64 y            ~%float64 z ~%float64 angle       # object rotation angle in camera frame (radians)~%~%~%"))
