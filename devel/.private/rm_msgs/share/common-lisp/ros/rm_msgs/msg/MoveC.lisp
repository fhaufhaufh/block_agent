...
(cl:defmethod loop-val ((m <MoveC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_msgs-msg:loop-val is deprecated.  Use rm_msgs-msg:loop instead.")
  (loop m))

(cl:ensure-generic-function 'trajectory_connect-val :lambda-list '(m))
(cl:defmethod trajectory_connect-val ((m <MoveC>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MoveC>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'loop)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'loop)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MoveC>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'End_Pose) istream)
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'loop)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'loop)) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MoveC>)))
  ...
  "4a51b555e13bfa444df1e7d9863b0ad6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MoveC)))
  "Returns md5sum for a message object of type 'MoveC"
  "4a51b555e13bfa444df1e7d9863b0ad6")
