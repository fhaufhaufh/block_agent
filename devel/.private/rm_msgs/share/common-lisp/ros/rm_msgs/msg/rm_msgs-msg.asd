...
(defsystem "rm_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "set_modbus_mode" :depends-on ("_package_set_modbus_mode"))
    (:file "_package_set_modbus_mode" :depends-on ("_package"))
    (:file "write_register" :depends-on ("_package_write_register"))
    (:file "_package_write_register" :depends-on ("_package"))
    (:file "write_single_register" :depends-on ("_package_write_single_register"))
    (:file "_package_write_single_register" :depends-on ("_package"))
  ))